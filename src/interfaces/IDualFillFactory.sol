...
interface IDualFillFactory {
    ...
    function CURVE_SUPPLY() external view returns (uint256); // 800_000_000e18
    function LP_SUPPLY() external view returns (uint256); // 219_000_000e18
